        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div>
            ...
            <p className="text-emerald-200/70 mt-2">
              ...
              {filteredProducts.filter((p) => p.stock > 0).length} in stock
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-3 w-full lg:w-auto">
              ...
              >
                ...
                <option value="in-stock" className="bg-gray-900">
                  In Stock
                </option>
                <option value="out-of-stock" className="bg-gray-900">
                  Out of Stock
                </option>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full">
                <thead className="bg-gradient-to-r from-emerald-900/50 to-teal-900/50">
                  <tr>
                    <th className="p-4 text-left text-emerald-300 font-semibold">
                      Product
                    </th>
                    <th className="p-4 text-left text-emerald-300 font-semibold">
                      Category
                    ...
                    <th className="p-4 text-center text-emerald-300 font-semibold">
                      Actions
                    </th>
                  </tr>
                </thead>
