...
export default function AddEditProduct() {
  ...
  const categories = {
    ...
    Toys: ["Educational Toys", "Electronic Toys", "RC Toys", "STEM Toys"],
        ...
        .then((data) => {
          if (data.product) {
            setForm({
              ...
              featuredKeywords: data.product.featuredKeywords?.join(", ") || "",
            });
        ...
        <div className="bg-gradient-to-br from-gray-800/80 to-gray-900/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-emerald-800/30 overflow-hidden">
          ...
          <div className="border-b border-emerald-800/30">
            <div className="flex overflow-x-auto">
              {["basic", "attributes", "images", "seo", "advanced"].map(
                (tab) => (
                  <button
                    key={tab}
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            {activeTab === "attributes" && (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="md:col-span-1">
                    ...
                    <input
                      ...
                      value={newAttr.key}
                      onChange={(e) =>
                        setNewAttr({ ...newAttr, key: e.target.value })
                      }
                      className="w-full bg-gray-800/50 border border-emerald-800/30 rounded-xl p-3 text-white placeholder-emerald-500/50 focus:outline-none focus:border-emerald-500 transition-all"
                    />
                  </div>
                ...
                {/* Attributes List */}
                <div className="mt-6">
                  <h4 className="text-lg font-medium text-emerald-200 mb-3">
                    Current Attributes
                  </h4>
            ...
            {activeTab === "images" && (
              ...
              >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      {existingImages.map((img, i) => (
                        <div
                          key={i}
                          className="bg-gray-900/50 rounded-xl p-3 border border-emerald-800/30"
                        >
                          <img
                            src={img.url}
                            alt="existing"
                ...
                <div>
                  ...
                  {newImages.length > 0 && (
                    <div className="mt-6">
                      <h5 className="text-md font-medium text-emerald-200 mb-3">
                        New Images Preview
                      </h5>
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {newImages.map((img, i) => (
                      ...
                      <div className="flex justify-between">
                        ...
                        <span
                          className={`font-medium ${
                            form.stock > 0 ? "text-emerald-400" : "text-red-400"
                          }`}
                        >
                          {form.stock || 0} units
                        </span>
                ...
                <button
                  ...
                  onClick={() =>
                    setActiveTab((prev) =>
                      prev === "basic"
                        ? "basic"
                        : ["basic", "attributes", "images", "seo", "advanced"][
                            [
                              "basic",
                              "attributes",
                              "images",
