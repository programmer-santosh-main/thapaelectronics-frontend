...
export default function ViewProduct() {
  ...
  const getDeliveryInfo = () => {
    ...
    const isKathmandu =
      deliveryLocation.city === "Kathmandu" ||
      deliveryLocation.city === "Bhaktapur" ||
      deliveryLocation.city === "Lalitpur";
                  ...
                  {product.discount > 0 && (
                    <>
                      ...
                      <span className="text-lg text-green-600 font-semibold">
                        Save रू{discountAmount.toFixed(2)} ({product.discount}%
                        off)
                      </span>
                    </>
                  )}
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-green-600">
                              {cartQuantity} × {product.name} • रू
                              {(cartQuantity * finalPrice).toFixed(2)}
                            </p>
                          </div>
                        </div>
                        <button
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Delivery charges apply (3-7 days). We'll contact
                                you.
                              </p>
                            </div>
                          </div>
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-gray-600">
                                Customs and delivery charges apply. Contact for
                                details.
                              </p>
                            </div>
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div className="bg-white border border-gray-200 rounded-2xl p-4">
                          ...
                          <p className="text-sm text-gray-600">
                            All products are securely packed
                          </p>
                        </div>
                        <div className="bg-white border border-gray-200 rounded-2xl p-4">
