...
export default function Navbar() {
  ...
  const fetchSiteData = async () => {
    try {
      ...
      if (data.success && data.site) {
        setSiteData({
          companyName: data.site.companyName || "Thapa Electronics",
  ...
  // Products dropdown items - Corrected icons
  const productsDropdownItems = [
    ...
    { 
      ...
      description: "Airbuds, Chargers, Gadgets"
    },
    { 
      path: "/smarthome", 
      label: "Smart Home", 
    ...
    { 
      ...
      description: "Electronic Toys, Gaming Gadgets"
    },
    { 
      path: "/auto", 
      label: "Automotive", 
    ...
    if (loading) {
      return (
        <div className="flex items-center space-x-2">
          <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-green-400 rounded-xl flex items-center justify-center shadow-lg animate-pulse">
            ...
            <img 
              ...
              onError={(e) => {
                ...
                e.target.parentElement.innerHTML = `
                  <div class="w-10 h-10 bg-gradient-to-br from-blue-400 to-green-400 rounded-xl flex items-center justify-center shadow-lg">
  ...
  const MobileLogo = () => {
    if (loading) {
      return (
        <div className="flex items-center space-x-2">
          <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-green-400 rounded-lg flex items-center justify-center shadow animate-pulse"></div>
        </div>
      );
    }
    ...
    return (
      <Link to="/" className="flex items-center space-x-2">
        {siteData.logo ? (
          <div className="w-8 h-8 rounded-lg flex items-center justify-center overflow-hidden shadow border border-gray-200">
            <img 
              ...
              onError={(e) => {
                e.target.style.display = 'none';
                e.target.parentElement.innerHTML = `
                  <div class="w-8 h-8 bg-gradient-to-br from-blue-400 to-green-400 rounded-lg flex items-center justify-center shadow">
          ...
          <div className="w-8 h-8 bg-gradient-to-br from-blue-400 to-green-400 rounded-lg flex items-center justify-center shadow">
    ...
    <>
                      ...
                      {showProductsDropdown && (
                        ...
                        >
                          <div className="px-4 py-2 border-b border-gray-100">
                            ...
                            <p className="text-xs text-gray-500">Browse our wide range of electronics</p>
                          </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              {user ? (
                <div className="relative">
                  ...
                  >
                    <div className="w-8 h-8 bg-gradient-to-br from-blue-100 to-green-100 rounded-full flex items-center justify-center border border-blue-200">
                ...
                <Link
                  to="/login"
                  className="hidden sm:flex items-center space-x-2 px-4 py-2.5 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-xl hover:from-blue-600 hover:to-green-600 transition-all shadow-md hover:shadow-lg"
                >
              ...
              <div className="px-4 py-4">
                ...
                <div className="flex items-center justify-center space-x-2 mb-4">
                  {siteData.logo ? (
                    ...
                    <div className="w-10 h-10 bg-gradient-to-br from-blue-400 to-green-400 rounded-xl flex items-center justify-center shadow">
                      <Sparkles className="w-6 h-6 text-white" />
                    </div>
                  )}
                ...
                <div className="space-y-1">
                  ...
                  {!user && (
                    <Link
                      to="/login"
                      onClick={() => setIsMenuOpen(false)}
                      className="flex items-center justify-center space-x-2 px-4 py-3 bg-gradient-to-r from-blue-500 to-green-500 text-white rounded-xl hover:from-blue-600 hover:to-green-600 transition-all mt-4"
                    >
                      <User className="w-4 h-4" />
      ...
      <div className="fixed bottom-0 left-0 right-0 md:hidden bg-white border-t border-gray-200 z-40 py-2 px-4 shadow-lg">
        <div className="flex justify-around items-center">
                      ...
                      >
                        <div className="p-4">
                          <div className="flex items-center justify-between mb-3">
                            <h3 className="font-semibold text-gray-900">Electronics Categories</h3>
                            <button
                              onClick={() => setShowProductsDropdown(false)}
          ...
          <Link
            to="/cart"
            className="flex flex-col items-center p-2 rounded-lg transition-colors text-gray-600 hover:text-blue-600 relative"
          >
            <div className="relative">
